...
def get_db_connection():
    ...
    try:
        ...
        if not conn_str:
             conn_str = 'postgresql://neondb_owner:npg_hKbw8UyIjXL5@ep-damp-shape-af55r83v-pooler.c-2.us-west-2.aws.neon.tech/neondb?sslmode=require'
...
def initiate_claim():
    ...
    try:
        ...
        if not match_lost_item_id:
            ...
            cursor.execute(
                'INSERT INTO "Items" ("ItemID", "UserID", "ItemType", "ItemName", "Description", "ItemStatus") VALUES (%s, %s, \'Lost\', %s, %s, \'正在联系中\')',
